...
const variantClasses: Record<GameButtonVariant, string> = {
  action:
    'rounded-2xl bg-gradient-to-b from-amber-300 via-amber-400 to-orange-500 font-black uppercase tracking-wide text-amber-950 shadow-[0_4px_0_#b45309,inset_0_1px_0_rgba(255,255,255,0.2)] hover:from-amber-200 hover:via-amber-300 hover:to-orange-400 hover:shadow-[0_4px_0_#b45309,0_0_18px_rgba(251,191,36,0.35),inset_0_1px_0_rgba(255,255,255,0.25)] focus-visible:shadow-[0_4px_0_#b45309,0_0_18px_rgba(251,191,36,0.35),inset_0_1px_0_rgba(255,255,255,0.25)] active:translate-y-0.5 active:shadow-[0_2px_0_#b45309,0_0_12px_rgba(251,191,36,0.25)] disabled:active:translate-y-0 disabled:shadow-[0_4px_0_#1e293b]',
  muted:
  ...
  emerald:
    'rounded-xl bg-gradient-to-b from-emerald-400 via-emerald-500 to-emerald-600 font-black uppercase tracking-wide text-white shadow-[0_4px_0_#047857,inset_0_1px_0_rgba(255,255,255,0.25)] hover:from-emerald-300 hover:via-emerald-400 hover:to-emerald-500 hover:shadow-[0_4px_0_#047857,inset_0_1px_0_rgba(255,255,255,0.3)] active:translate-y-0.5 active:shadow-[0_2px_0_#047857,inset_0_1px_0_rgba(255,255,255,0.2)] disabled:from-slate-700 disabled:via-slate-800 disabled:to-slate-900 disabled:text-slate-400 disabled:opacity-90 disabled:shadow-[0_4px_0_#0f172a] disabled:hover:from-slate-700 disabled:hover:via-slate-800 disabled:hover:to-slate-900 disabled:active:translate-y-0',
  teal:

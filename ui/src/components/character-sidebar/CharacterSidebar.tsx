          ...
          >
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full rounded-2xl bg-slate-800/90 px-5 py-3.5 text-sm font-semibold text-slate-300 transition hover:bg-slate-700/90"
              >
                Назад
              </motion.button>
              <motion.button
                ...
                className="w-full rounded-2xl bg-gradient-to-b from-emerald-500 to-teal-600 px-5 py-3.5 text-sm font-bold text-white shadow-[0_0_28px_rgba(16,185,129,0.4),inset_0_1px_0_rgba(255,255,255,0.25)] transition hover:from-emerald-400 hover:to-teal-500 disabled:opacity-60"
              >

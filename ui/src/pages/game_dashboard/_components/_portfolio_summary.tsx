...
import { SECONDARY_TEXT_DARK } from "../_model/constants";
import type { portfolio_row } from "../_model/types";
import { calc_portfolio_stats } from "../_model/utils";
  ...
  return (
    <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
      {metrics.map((metric) => (
        ...
        >
          <p
            className={`text-[10px] font-bold uppercase tracking-wider ${SECONDARY_TEXT_DARK}`}
          >
            {metric.label}
          </p>

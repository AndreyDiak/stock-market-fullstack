...
} from './model/nav_items'
import type { dashboard_tab, left_sidebar_props, sidebar_nav_item } from './model/types'
...
function SidebarNavButton({
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-bold leading-tight tracking-wide">{item.label}</span>
    </button>
  )
}
...
function SidebarFooterButton({
  ...
  return (
    ...
    >
      ...
      <span className="text-sm font-bold leading-tight tracking-wide">{label}</span>
    </button>
  )
}

export function LeftSidebar({ activeTab, onTabChange, theme, onOpenExit }: left_sidebar_props) {

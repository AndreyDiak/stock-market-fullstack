        ...
        <div className="flex w-full max-w-md flex-col items-center">
          ...
          >
            <motion.div variants={menuItemVariants}>
              <GameButton onClick={() => navigate('/slots')}>Играть</GameButton>
            </motion.div>

            <motion.div variants={menuItemVariants}>
              <GameButton variant="secondary">Настройки</GameButton>
            </motion.div>

            <motion.div variants={menuItemVariants}>
              <GameButton variant="danger" onClick={() => void handleLogout()}>
                Выйти из аккаунта
              </GameButton>
            </motion.div>
          </motion.div>

...
export const REAL_ESTATE: RealEstateData[] = [
  ...
  },
  {
    id: 'boat',
    name: 'Лодка',
    description: 'Моторная лодка для рыбалки и прогулок. Шаг к яхте.',
    basePrice: 70000,
    monthlyPayment: 1200,
    installmentMonths: 60,
    isTradable: true,
  ...
  },
  {
    id: 'hiking_ticket',
    name: 'Билет в поход',
    description: 'Путешествие на природу. Первый шаг к кругосветке.',
    basePrice: 8000,
    monthlyPayment: 0,
    installmentMonths: 1,
    isTradable: true,
  },
  {
    ...
    description: 'Редкая карточка из коллекции. Basis для дорогой картины.',
    basePrice: 50000,
    monthlyPayment: 0,
    installmentMonths: 1,
    isTradable: true,
